...
import com.surv.modules.CalculateMaterialComputeShader;
import com.surv.modules.ComputeBuffer;
import com.surv.modules.DensityPrimitive;
import com.surv.modules.Sizeable;
...
public class CalculateMaterialService {
    ...
    public void calculate(Vec3i offset, int sampleScale, int[] fieldMaterials) {
        ...
        densityPrimitiveComputeBuffer.setData((Sizeable[]) primitiveMods);

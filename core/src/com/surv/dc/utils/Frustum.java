...
public class Frustum {
    ...
    public void calculateFrustum(Matrix4f mvp) {
        ...
        Matrix4f mvpCopy = new Matrix4f(-mvp.m[0][0], -mvp.m[1][0], -mvp.m[2][0], -mvp.m[3][0],
                mvp.m[0][1], mvp.m[1][1], mvp.m[2][1], mvp.m[3][1],
                mvp.m[0][2], mvp.m[1][2], mvp.m[2][2], mvp.m[3][2],
                mvp.m[0][3], mvp.m[1][3], mvp.m[2][3], mvp.m[3][3]);

        // ax * bx * cx +  d = 0; store a,b,c,d

        //left plane
        Vec4f leftPlane = new Vec4f(
                mvpCopy.get(3, 0) + mvpCopy.get(0, 0),
                mvpCopy.get(3, 1) + mvpCopy.get(0, 1),
                mvpCopy.get(3, 2) + mvpCopy.get(0, 2),
                mvpCopy.get(3, 3) + mvpCopy.get(0, 3));
        ...
        Vec4f botPlane = new Vec4f(
                mvpCopy.get(3, 0) + mvpCopy.get(1, 0),
                mvpCopy.get(3, 1) + mvpCopy.get(1, 1),
                mvpCopy.get(3, 2) + mvpCopy.get(1, 2),
                mvpCopy.get(3, 3) + mvpCopy.get(1, 3));
        ...
        Vec4f nearPlane = new Vec4f(
                mvpCopy.get(3, 0) + mvpCopy.get(2, 0),
                mvpCopy.get(3, 1) + mvpCopy.get(2, 1),
                mvpCopy.get(3, 2) + mvpCopy.get(2, 2),
                mvpCopy.get(3, 3) + mvpCopy.get(2, 3));

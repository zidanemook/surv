...
public class MeshBuffer {
    ...
    public int getSizeInBytes() {
        int sizeOfFloat = Float.SIZE / Byte.SIZE; // Size of float in bytes
        int sizeOfInt = Integer.SIZE / Byte.SIZE; // Size of int in bytes

        return numVertices * sizeOfFloat + numIndicates * sizeOfInt;
    }

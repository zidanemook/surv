...
import com.surv.physics.WorldCollisionNode;
...
import com.surv.dc.impl.Morton3D;
import com.surv.dc.impl.simplifier.MeshSimplificationOptions;
import com.surv.dc.impl.simplifier.NgMeshSimplify;
import com.surv.dc.utils.Aabb;
import com.surv.dc.utils.Frustum;
import com.surv.dc.utils.Ray;
import com.surv.dc.utils.VoxelHelperUtils;

import java.text.NumberFormat;
import java.util.*;
import java.util.logging.Logger;

import static com.surv.dc.utils.VoxelHelperUtils.checkNodeForSelection;
...
public class ChunksManager {
    ...
    public ChunksManager(VoxelOctree voxelOctree, MeshGenerationContext meshGen, Physics ph, Camera cam,
        ...
        update();
        //if(enablePhysics) {
        //    physics.Physics_SpawnPlayer(cam.position);
        //}
    }
    ...
    public void update() {
        ...
        selectActiveChunkNodes(root, false, new Vec3f(camera.position.x, camera.position.y, camera.position.z), selectedNodes);
